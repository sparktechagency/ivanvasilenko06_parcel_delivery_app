...
import 'package:parcel_delivery_app/screens/termsNconditon/controller/terms_and_condition_controller.dart';
...
class TermsAndCondition extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.getTheTermsandCondition();
    });
             ...
             crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Obx(() {
                  ...
                  if (controller.termsAndConditionData.value?.data?.content != null &&
                      controller.termsAndConditionData.value!.data!.content!.isNotEmpty) {
                    return HtmlWidget(
                      controller.termsAndConditionData.value!.data!.content!,
